...
namespace Datlv\Article\Controllers;

use CategoryManager;
use DataTables;
use Illuminate\Http\Request;
use Datlv\Article\Article;
use Datlv\Article\ArticleTransformer;
use Datlv\Article\Request as ArticleRequest;
...
class BackendController extends BaseController
{
    ...
    /**
     * @param \Datlv\Article\Request $request
     *
    ...
    /**
     * @param \Datlv\Article\Article $article
     *
     * @return \Illuminate\View\View
     */
